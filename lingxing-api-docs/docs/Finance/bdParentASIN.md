...
| :------------ | :------------ | :------------ | :------------ |
| `/bd/profit/report/open/report/parent/asin/list` | HTTPS | POST | 10 |
...
| searchValue |搜索的值  |否 | [array] | ["B09MT9BKGH","B09MT3989Q"] |
| currencyCode|币种code |否 |[string] | CNY  |
| summaryEnabled| 是否按父asin汇总返回：<br>false 默认值 <br>true|否 | [boolean] | false  |
