...
| :------------ | :------------ | :------------ | :------------ |
| `/bd/profit/report/open/report/seller/list` | HTTPS | POST | 10 |
...
| summaryEnabled| 是否按店铺汇总返回：<br>false 默认值 <br>true                                           |否 | [boolean] | false  |
...
| data>>records>>sid                          | [int]        | 店铺id                                                       |        |
| data>>records>>postedDateLocale             | [string]     | 本地时间，年月日                                             |        |
| data>>records>>storeName                    | [string]     | 店铺                                                         |        |
| data>>records>>countryCode                  | [string]     | 国家编码                                                     |        |
| data>>records>>country                      | [string]     | 国家中文名                                                   |        |
| data>>records>>sellerPrincipalRealname      | [string]     | 店铺负责人                                                   |        |
        ...
        "records": [
            {
                ...
                "roi": -1.0000,
                "sid": 101,
                "postedDateLocale": "2023-08-03",
                "storeName": "8pspeed-US-1",
                "countryCode": "US",
                "country": "美国",
                "sellerPrincipalRealname": "xxx,xxx",
                "currencyCode": "USD",
                "currencyIcon": "$",
                "platformIncome":0,
                "platformFee":0,
