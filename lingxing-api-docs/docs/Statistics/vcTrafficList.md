...
| :------------ |:-----| :------------ | :------------ |
| `/basicOpen/vc/report/traffic/list` | HTTPS | POST | 1 |
...
## 请求cURL示例
```
curl --location 'https://openapi.lingxing.com/basicOpen/vc/report/traffic/list?access_token=value&timestamp=value&sign=value&app_key=value' \
...
| request_id|请求链路id|是|[string]| 2d5d373881a14e9f9b745a566cce8f81 |
...
| data>>list>>glanceViews |浏览量|是|[int]| 100 |
| total |总数|是|[int]| 1 |
...
```
{
    ...
    "message": "success",
    "error_details": [],
    "request_id": "2d5d373881a14e9f9b745a566cce8f81.178.17739962885581817",
