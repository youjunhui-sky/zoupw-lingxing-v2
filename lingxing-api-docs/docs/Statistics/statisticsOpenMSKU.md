...
| :------------ | :------------ | :------------ | :------------ |
| `/bd/profit/statistics/open/msku/list` | HTTPS | POST | 10 |
...
| searchField | 搜索值类型：msku|否|[string]| msku |
| searchValue | 搜索值 | 否 |[array]|test123 |
...
| data>>records>>localSku                     | 本地SKU                    | [string]  |        |
...
| data>>records>>sharedFbaInboundDefectFee    | 计划外服务费                | [number]  |        |
...
| data>>records>>postedDateLocale             | 按天汇总                   | [string]  |        |
| data>>records>>sharedAdsSbSales             | sb广告销售额                 | [number] |        |
| data>>records>>sharedAdsSbvSales            | sbv广告销售额                | [number] |        |
| data>>records>>sharedAdsSbSalesQuantity     | sb广告销量                  | [int] |        |
| data>>records>>sharedAdsSbvSalesQuantity    | sbv广告销量                 | [int] |        |
| data>>records>>sharedAdsAlCost              | Live广告                   | [number]  |        |
| data>>records>>sharedAdsCcCost              | 创作者计划                 | [number]  |        |
| data>>records>>sharedAdsSspaotCost          | ST广告                     | [number]  |        |
| data>>records>>sharedAdsSarCost             | 零售商赞助广告             | [number]  |        |
| data>>records>>sharedAwdProcessingFee       | AWD处理费                  | [number]  |        |
| data>>records>>sharedAwdTransportationFee   | AWD运输费                  | [number]  |        |
| data>>records>>sharedAwdStorageFee          | AWD仓储费                  | [number]  |        |
| data>>records>>sharedStarStorageFee         | 卫星仓仓储费               | [number]  |        |
| data>>records>>sharedFbaInboundDefectFee    | 计划外服务费               | [number]  |        |
| data>>records>>fbaStorageFeeAccrual         | 月仓储费-本月计提          | [number]  |        |
| data>>records>>fbaStorageFeeAccrualDifference | 月仓储费-上月冲销        | [number]  |        |
| data>>records>>longTermStorageFeeAccrual    | 长期仓储费-本月计提        | [number]  |        |
| data>>records>>longTermStorageFeeAccrualDifference | 长期仓储费-上月冲销   | [number]  |        |
| data>>records>>sharedMfnPostageFee          | mfn邮费                    | [number]  |        |
| data>>records>>sharedReceivablesDeductions  | 透明计划标签费             | [number]  |        |
| data>>records>>sharedAmazonShippingChargeAdjustments | 亚马逊物流运费调整    | [number]  |        |
        ...
        "records": [
            {
                ...
                "id": "52536",
                "dataDate": "2023-07-18",
                "smallImageUrl": "https://xxx/xxxx.jpg",
                "msku": "test123",
                "asin": "B07DFKF9SG",
                "sid": 104,
                ...
                "listingTagIds": "907224269891252258,907340940162893052",
                "categoryName": "",
                "brandName": "",
                "currencyCode": "USD  ",
                "currencyIcon": "$     ",
