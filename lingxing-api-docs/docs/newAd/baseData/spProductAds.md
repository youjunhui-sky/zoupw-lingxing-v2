...
| :------------ | :------------ | :------------ | :------------ |
| `/pb/openapi/newad/spProductAds` | HTTPS | POST | 10 |
...
|data>>ad_id|商品广告id|是|[number]|800000000000080800|
|data>>state|状态|是|[string]|enabled|
|data>>sku|MSKU|是|[string]|PEE-11|
|data>>asin|ASIN|是|[string]|B08D87V2BV|
