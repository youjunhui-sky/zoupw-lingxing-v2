...
| :------------ | :------------ | :------------ | :------------ |
| `/pb/openapi/newad/sdAdGroups` | HTTPS | POST | 10 |
...
|data|响应数据|是|[array]| |
|data>>campaign_id|广告活动ID|是|[number]|77765272166097|
|data>>ad_group_id|广告组ID|是|[number]|800000000000136100|
|data>>profile_id|亚马逊店铺数字id|是|[number]|121923590660074|
|data>>name|广告组名称|是|[string]|test-group-9|
|data>>default_bid|默认竞价|是|[number]|0.02|
|data>>state|状态|是|[string]|enabled|
|data>>creation_date|创建时间|是|[string]| |
