...
| :------------ | :------------ | :------------ | :------------ |
| `/pb/openapi/newad/hsaNegativeTargets` | HTTPS | POST | 10 |
...
|data|响应数据|是|[array]| |
|data>>target_id|投放ID|是|[number]|800000000000080400|
...
|data>>expression_type|表达式类别|是|[string]| |
|data>>expression|表达式|是|[string]|[{"type": "asinSameAs", "value": "B0DEMO6789"}]|
|data>>resolved_expression|解析的表达式|是|[string]|[{"type": "asinSameAs", "value": "B0DEMO6789"}]|
