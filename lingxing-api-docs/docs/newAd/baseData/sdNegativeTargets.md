...
| :------------ | :------------ | :------------ | :------------ |
| `/pb/openapi/newad/sdNegativeTargets` | HTTPS | POST | 10 |
...
|data|响应数据|是|[array]| |
|data>>target_id|商品定位ID|是|[number]|800000000000080500|
|data>>campaign_id|广告活动ID|是|[number]|223900514257817|
|data>>ad_group_id|广告组ID|是|[number]|24195996870573|
|data>>profile_id|亚马逊店铺数字id|是|[number]|121923590660074|
|data>>expression_type|表达式类别|是|[string]|manual|
|data>>expression|表达式|是|[string]|[{"type": "asinSameAs", "value": "B086GRKQLH"}]|
|data>>resolved_expression|解析的表达式|是|[null]| |
