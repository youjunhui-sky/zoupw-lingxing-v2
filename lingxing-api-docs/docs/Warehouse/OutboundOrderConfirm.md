...
| :------------ | :------------ | :------------ | :------------ |
| `/basicOpen/outboundOrder/outbound/setOutbound` | HTTPS | POST | 1 |

## 请求参数

| 参数名 | 说明    | 必填 | 类型 | 示例 |
| :------------ |:------| :------------ | :------------ | :------------ |
|orderSn| 出库单单号 |否|[array]|IB240730005|
...
```
{
    ...
    "message": "操作成功",
    "error_details": [],
    "request_id": "2b584765f134456cb97cb1f4f2def46c.1744256665337",
    "response_time": "2025-04-10 11:44:26",
    "data": {
        "success": 0,
        "fail": 2,
        "total": 2,
