...
| :------------ |:-----| :------------ | :------------ |
| `/amzStaServer/openapi/inbound-shipment/commitStaDeliverTime` | HTTPS | POST | 1 |
...
| 参数名 | 说明 | 必填 | 类型 | 示例 |
| :------------ | :------------ | :------------ | :------------ | :------------ |
|deliveryWindowOptionId|送达时间id|是|[string]| |
|endDate|(北京时间)<br>备注:格式：YYYY-MM-DD|是|[string]| |
...
|startDate|(北京时间)<br>备注:格式：YYYY-MM-DD|是|[string]| ||


## 请求cURL示例
```
curl --location 'https://openapi.lingxing.com/amzStaServer/openapi/inbound-shipment/commitStaDeliverTime?access_token=value&timestamp=value&sign=value&app_key=value' \
--header 'Content-Type: application/json' \
--data '{
    "deliveryWindowOptionId": "送达时间id",
    "endTime": "2023-12-2",
