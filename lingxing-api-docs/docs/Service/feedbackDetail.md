...
| :------------ | :------------ | :------------ | :------------ |
| `/erp/sc/cs/feedbackReport/detail` | HTTPS | POST | 3 |
...
|data|响应数据|是|[array]| |
|data>>report_date|日期|是|[string]|2021-04-26|
|data>>feedback_num|每日feedback新增数|是|[number]|11|
|data>>five_star|5星feedback新增数|是|[number]|10|
|data>>four_star|4星feedback新增数|是|[number]|1|
|data>>three_star|3星feedback新增数|是|[number]| |
|data>>two_star|2星feedback新增数|是|[number]| |
|data>>one_star|1星feedback新增数|是|[number]| |
|total|总数|是|[int]|2|
...
```
{
    ...
    "message": "success",
    "error_details": [],
    "request_id": "F8A5EBA7-F132-0FCC-B7D2-5F9725A7C23D",
    "response_time": "2022-05-16 17:52:11",
    "data": [
        {
            "report_date": "2021-04-26",
            "feedback_num": 11,
            "five_star": 10,
            "four_star": 1,
            "three_star": 0,
