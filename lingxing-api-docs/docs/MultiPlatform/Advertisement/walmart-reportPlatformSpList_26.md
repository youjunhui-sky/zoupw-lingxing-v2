...
| :------------ |:-----| :------------ | :------------ |
| `/basicOpen/multiplatform/ads/reportPlatformSpList` | HTTPS | POST | 1 |
...
## 请求cURL示例
```
curl --location 'https://openapi.lingxing.com/basicOpen/multiplatform/ads/reportPlatformSpList?access_token=value&timestamp=value&sign=value&app_key=value' \
...
| data>>list>>campaignAndTargetingName | 广告活动和投放类型组合，格式：campaignType+targetingType | 是 | [string] | sponsoredProducts-自动定向 |
...
| data>>list>>key | 唯一键，用于前端列表展示的唯一标识 | 是 | [string] | 20241112_456789123_Mobile |
