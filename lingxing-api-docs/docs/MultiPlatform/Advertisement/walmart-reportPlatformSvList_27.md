...
| :------------ |:-----| :------------ | :------------ |
| `/basicOpen/multiplatform/ads/reportPlatformSvList` | HTTPS | POST | 1 |
...
## 请求cURL示例
```
curl --location 'https://openapi.lingxing.com/basicOpen/multiplatform/ads/reportPlatformSvList?access_token=value&timestamp=value&sign=value&app_key=value' \
...
| data>>list>>campaignAndTargetingName | 广告活动和投放类型组合，格式：campaignType+targetingType | 是 | [string] | video-自动定向 |
