...
| :------------ | :------------ | :------------ | :------------ |
| `/basicOpen/multiplatform/profit/report/sku` | HTTPS | POST | 1 |
...
|length|分页长度，默认1000|是|[number]|20|
...
|mids|国家id，多个使用英文逗号分隔|是|[string]|NA,MX,BR,US,CA|
...
|searchField|搜索值类型：<br>local_sku SKU<br>platform_order_no 平台单号|否|[string]|local_sku|
...
```
{
    ...
    "message": "success",
    "error_details": [],
    "request_id": "a0d54debf93140f3b58d1ed81e8e3583.214.17289863765624387",
    "response_time": "2024-10-15 17:59:36",
    "data": {
        "totalSum": {
            "currencyCode": "CNY",
            "currencyIcon": "￥",
