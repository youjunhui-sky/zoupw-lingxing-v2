# 查询建议信息-ASIN
支持查询系统FBA补货建议中ASIN维度详细信息

## 接口信息

| API Path | 请求协议 | 请求方式 | [令牌桶容量](/docs/Guidance/newInstructions?id=_5-限流算法说明) |
| :------------ | :------------ | :------------ | :------------ |
| `/erp/sc/routing/fbaSug/asin/getInfo` | HTTPS | POST | 1 |
...
|data>>mode|模式：<br>0 普通<br>1 海外仓中转|是|[string]|1|
...
```
{
    ...
    "data": {
        ...
        "quantity_sug_purchase": 20,
        "quantity_sug_purchase_air": 0,
        "quantity_sug_purchase_sea": 0,
        "quantity_sug_local_to_oversea": 290,
        ...
        "sug_date_send_local": "2023-04-11",
        "sug_date_purchase": "2023-04-11",
        "sug_date_send_oversea": "1970-01-01",
        "sales_avg_3": 0,
        "sales_avg_7": 0,
        "sales_avg_14": 0,
        "sales_avg_30": 0,
