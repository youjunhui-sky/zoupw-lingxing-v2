# 批量设置规则 - ASIN
支持批量按ASIN维度设置FBA补货建议规则

## 接口信息

| API Path | 请求协议 | 请求方式 | [令牌桶容量](/docs/Guidance/newInstructions?id=_5-限流算法说明) |
| :------------ | :------------ | :------------ | :------------ |
| `/erp/sc/routing/fbaSug/asin/setConfigs` | HTTPS | POST | 1 |

## 请求参数

| 参数名 | 说明 | 必填 | 类型 | 示例 |  
| :------------ | :------------ | :------------ | :------------ | :------------ |  
|asin_list|asin信息|是|[array]| |
|asin_list>>sid|店铺id ，对应[查询亚马逊店铺列表](docs/BasicData/SellerLists)接口对应字段【sid】|是|[number]|3|
|asin_list>>asin|ASIN|是|[string]|XXXXX|
...
|error_details>>asin|asin|是|[string]|xxxx|
...
```
{
    ...
    "message": "success",
    "error_details": [],
    "request_id": "CD306B3E-00C9-EEC0-8EA0-54CB49547FFF",
    "response_time": "2021-11-11 17:51:44",
    "data": {},
    "total": 0
}
```
