# 单个设置规则-ASIN
支持设置单个ASIN的FBA补货建议规则

## 接口信息

| API Path | 请求协议 | 请求方式 | [令牌桶容量](/docs/Guidance/newInstructions?id=_5-限流算法说明) |
| :------------ | :------------ | :------------ | :------------ |
| `/erp/sc/routing/fbaSug/asin/setConfig` | HTTPS | POST | 1 |
...
|request_id|请求链路id|是|[string]|F5AE35F0-174E-7746-A3A4-D74D323DE01B|
...
```
{
    ...
    "message": "success",
    "error_details": [],
    "request_id": "F5AE35F0-174E-7746-A3A4-D74D323DE01B",
