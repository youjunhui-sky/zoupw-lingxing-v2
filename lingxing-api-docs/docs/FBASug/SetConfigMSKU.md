# 单个设置规则-MSKU
支持设置单个MSKU的FBA补货建议规则

## 接口信息

| API Path | 请求协议 | 请求方式 | [令牌桶容量](/docs/Guidance/newInstructions?id=_5-限流算法说明) |
| :------------ | :------------ | :------------ | :------------ |
| `/erp/sc/routing/fbaSug/msku/setConfig` | HTTPS | POST | 1 |

## 请求参数

| 参数名 | 说明 | 必填 | 类型 | 示例 |  
| :------------ | :------------ | :------------ | :------------ | :------------ |  
|sid|店铺id ，对应[查询亚马逊店铺列表](docs/BasicData/SellerLists)接口对应字段【sid】|是|[int]| 3|
|msku|MSKU|是|[string]| xxx|
...
|days_oversea|已弃用（原本地至海外仓天数-海运）|否|[number]|20|
...
|config_list>>type|类型： 0 固定，1 动态|是|[int]| 1|
...
|denoise_list>>type|类型：1 固定值去噪，2 百分比去噪|是|[int]|1|
...
|request_id|请求链路id|是|[string]|BBBD761F-25C9-3C94-0AC4-358462AED17F|
|response_time|响应时间|是|[string]|2021-06-09 14:46:41|
|data|响应数据|是|[object]|  |
|total|总数|是|[int]|0|
...
```
{
    ...
    "message": "success",
    "error_details": [],
    "request_id": "D1A58D16-B0F6-F15C-5E83-7DADA07165B1",
    "response_time": "2021-11-11 17:53:14",
    "data": {},
    "total": 0
}
```
